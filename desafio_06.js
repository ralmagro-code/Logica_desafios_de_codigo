...
// TODO: Defina uma função chamada "combinandoNomesPokemons" que recebe um parâmetro chamado (nomeEntrada);
...
// Definindo uma função chamada "combinandoNomesPokemons" que recebe um parâmetro chamado (palavra), fornecido pelo usuário;
